...
export default function SignIn() {
    ...
    try {
      ...
      if (result?.error) {
        if (result.error.includes('OAuthCallback')) {
          setError('Google OAuth is not properly configured. Please check your Google Console settings.')
        } else {
  ...
  const handleFacebookSignIn = async () => {
    ...
    try {
      ...
      if (result?.error) {
        if (result.error.includes('OAuthCallback')) {
          setError('Facebook OAuth is not properly configured. Please check your Facebook App settings.')
        } else {
          ...
          <div className="text-center">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Sign in to access our premium watch collection
              </p>
            </div>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-1 gap-3">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 disabled:opacity-50 disabled:cursor-not-allowed transition duration-200"
              >
